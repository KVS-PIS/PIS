...
<?php 
	...
	$final_name2  = 'No. of Sanctioned / In-Positions / Vacancy at'.' '.$name_array['label'].'- '.$name_array['name'] ;
	$final_name ="";
	}else{
	$final_name2 = "No. of Sanctioned / In-Positions / Vacancy at HQ" ;
	$final_name ="";
	} 
?>
<!DOCTYPE html>
        ...
        <div class="container-fluid">
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-primary o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="#">
                            <span class="float-left" style="font-size: 20px"><?php  echo ($REG[0]['TOT'])? $REG[0]['TOT'] : 0 ; ?></span>
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-warning o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="#">
                            <span class="float-left" style="font-size: 20px"><?php  echo ($REG[0]['C_TOT'])? $REG[0]['C_TOT'] : 0 ; ?></span>
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 mb-3">
            ...
            <div class="row ml-1 mr-1">
                <div class="col-md-12 text-center btn btn-block bg-primary text-white" style=" line-height: 50px; font-size: 18px;">
                    <?php //show($RO); 
                        echo "HEAD QUARTER / DEPT : ".strtoupper($HQ->username);
                    ?>
                </div>
            </div>
...
// Add data
chart.data = [
            <?php if(isset($HQG) && !empty($HQG)){
				$DH=100*COUNT($VAC_VS_INPOS);
            foreach($HQG as $H){
            ?>
                {
                  "country": "<?php echo ($H['DESIG_NAME'])? $H['DESIG_NAME'] : '' ?>",
                  "visits": <?php echo ($H['TOT'])? $H['TOT'] : '' ?>,
...
var valueAxis = chart.yAxes.push(new am4charts.ValueAxis());
valueAxis.title.text = "<?php echo $final_name ; ?>";
valueAxis.title.fontWeight = "bold";
// Create series
