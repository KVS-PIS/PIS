        ...
        <div class="container-fluid">
            ...
            <div class="row ml-1 mr-1">
                <div class="col-md-12 text-center btn btn-block bg-primary text-white" style=" line-height: 50px; font-size: 18px;">
                    <?php 
                        //show($ZT);
                        echo 'ZIET - '.strtoupper($ZT->region_name); 
                    ?>
                </div>
            </div>
            <div class="row">
...
// Add data
chart.data = [
<?php if(isset($ziet) && !empty($ziet)){
	$DH=100*COUNT($VAC_VS_INPOS);
 foreach($ziet as $zie){
	?>
{
  "country": "<?php echo ($zie['designation_name'])? $zie['designation_name'] : '' ?>",
  "visits": <?php echo ($zie['total'])? $zie['total'] : '' ?>,
